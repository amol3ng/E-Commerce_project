  ...
  <nav class="nav" :class="{ scrolled }">
    <div class="nav-inner">
      ...
      <div class="nav-links">
        ...
        <router-link to="/brands#scanners" class="nav-link cultivate">Cultivate Your Own</router-link>
    ...
    <transition name="menu-drop">
      <div v-if="menuOpen" class="mobile-menu">
        ...
        <template v-if="user">
          <router-link to="/orders" class="mob-link" @click="menuOpen = false">Orders</router-link>
          <router-link to="/cart" class="mob-link" @click="menuOpen = false">
...
.logo-text {
  ...
  font-size: 24px; letter-spacing: 0.15em; color: #2d1f14;
}
...
.cart-btn {
  ...
  color: #c4784a; text-decoration: none; transition: background 0.2s;
}
...
.mobile-menu {
  ...
  border-top: 1px solid rgba(196, 120, 74, 0.15);
...
.mob-link {
  ...
  letter-spacing: 0.14em; text-transform: uppercase;
  color: rgba(45, 31, 20, 0.55); text-decoration: none;
  padding: 12px 0; border-bottom: 1px solid rgba(45, 31, 20, 0.06);
  transition: color 0.2s;
}
.mob-link:hover,
.mob-link.router-link-active { color: #2d1f14; }
...
.menu-drop-leave-active { transition: opacity 0.25s ease, transform 0.25s ease; }
